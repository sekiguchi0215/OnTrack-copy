...
class FieldErrors extends React.Component {
	...
	valRequired() {
		...
		if (typeof val == "number") {
			if (val == undefind || val == null || isNaN(parseInt(val.toString()))) { return false; }
		} else {
			if (!val) { return false; }
		}
	...
	buildErrorMessages() {
		...
		if (this.props.validations.greaterThan != undefind && !this.valGreaterThan()) { errs.push(`${this.props.label} must be greater than ${this.props.validations.greaterThan}`); }
