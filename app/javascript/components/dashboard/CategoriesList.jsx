...
import CategroyFormModal from "../categories/FormModal"
...
class CategoriesList extends React.Component {
	...
	renderCategory(category, idx) {
		...
		if (category == "addButton") {
			...
			markup = <CategoryWithExpensesAndSpend={category} onChange={this.props.onChange} colorToSkip={this.colorsToSkip()}
...
CategoriesList.propTypes = {
	categoriesWithExpensesAndSpend: PropType.array,
